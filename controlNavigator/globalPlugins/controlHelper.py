...
controlGuides[ROLE_LINK]=u"このリンクをクリックするには、エンターキーを押します。次のリンクやボタンに移動するには、タブキーを押します。ここからテキストを読むには、下矢印キーで読み進めるか、{NVDA}キーを押しながらAキーを押します。"
...
controlGuides[ROLE_PARAGRAPH]=u"文章を読むには、上下左右の矢印キーを押します。自動的に読み進めるには、NVDAキーを押しながら、Aキーを押します。"
...
controlGuides[ROLE_MENUBUTTON]=u"メニューを表示するには、エンターキーを押します。その後、上下の矢印キーで項目を選択できます。"
